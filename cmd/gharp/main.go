...
func run() error {
	...
	rec := reconciler.New(st, reconciler.NewExecDocker(), gh, log, cfg.RunnerMaxLifetime, cfg.ContainerNamePrefix, cfg.RunnerWorkdirRoot, cfg.MaintenanceCommand, cfg.MaintenanceInterval)
	go func() {
